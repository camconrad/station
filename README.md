...
## Overview
Station is an automated task compensation software that streamlines workplace collaboration. It facilitates task communication, assignment, and on-demand payouts in USDC on Arbitrum One, triggered when a task is moved from "Doing" to "Done," ensuring timely compensation for completed work.
