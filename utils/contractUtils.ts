...
export const getStationContract = (signerOrProvider: ethers.Signer | ethers.BrowserProvider) => {
...
export const createTaskOnContract = async (signer: ethers.Signer, description: string, assignee: string, reward: number) => {
